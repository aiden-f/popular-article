...
export const WideSearchCoupangBanner = ({ keyword, condition }: { keyword: string, condition?: string }) => {
    ...
    <div className="mb-8 w-full">
      <div className='flex items-center justify-between mb-4 gap-3'>
        <div className='flex items-center gap-3'>
          ...
          <div className='border border-slate-200 text-[10px] px-2 py-0.5 font-bold text-slate-400 bg-slate-50 rounded uppercase tracking-wider'>
            {'광고'}
          </div>
        </div>
      ...
      <ScrollContainer className='overflow-hidden cursor-grab active:cursor-grabbing outline-none'>
